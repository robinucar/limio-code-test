...
module.exports = function (webpackEnv) {
  ...
  const designSystem = process.argv.includes("--which") ? "which" : process.argv.includes("--economist") ? "economist" : "default"
  ...
  return {
    ...
    output: {
      ...
      filename: "static/js/[name].[contenthash:8].js", //, isEnvProduction ? "static/js/[name].[contenthash:8].js" : isEnvDevelopment && "static/js/bundle.js",
